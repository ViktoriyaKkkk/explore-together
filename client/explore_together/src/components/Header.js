			...
			<nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
				<div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
					<a href="https://flowbite.com" className="flex items-center">
						...
						<span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">ExploreTogether</span>
					</a>
					<div className="flex items-center lg:order-2">
						{ userStore._isAuth ?
							<Link href='/' onClick={()=>userStore.setIsAuth(false)}
							 ...
							 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800'>
							Выйти</Link>
							:
							<Link href="/" onClick={()=>userStore.setIsLogin(!userStore._isLogin)}
										className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4
							 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5
							 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
								{
					...
					<div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
						<ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
								...
								<Link href="/about"
									 ...
									 dark:border-gray-700">About us</Link>
						</ul>
					</div>
				</div>
			</nav>
